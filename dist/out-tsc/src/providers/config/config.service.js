...
let ConfigService = class ConfigService {
    constructor(
        ...
        this.consumerKey = "ck_d8094792f199300ae82f48a447026b4ea46b8cb9";
        this.consumerSecret = "cs_3095ea48b6071e285a77fc1cd039eca8c7339a2a";
        this.showIntroPage = 1; // show/hide intro page value 1 for show, 0 for hide
        this.appInProduction = true;
        this.productSlidesPerPage = 3;
        ...
        this.homePage = 1;
        this.categoryPage = 1;
        this.siteUrl = "https://everday.ug";
        this.appName = "Everyday Farms";
        this.packgeName = 1;
        this.introPage = 1;
        this.myOrdersPage = 1;
        this.newsPage = 1;
