...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["notifications-notifications-module"], {
  ...
  function srcAppNotificationsNotificationsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NotificationsPage = /*#__PURE__*/function () {
      function NotificationsPage(navCtrl, shared, config, http, loading, applicationRef, popoverCtrl, appEventsService) {
        var _this = this;
        ...
        var cardScratched = this.appEventsService.subscribe("cardScratched");
        cardScratched.subscriptions.add(cardScratched.event.subscribe(function (data) {
