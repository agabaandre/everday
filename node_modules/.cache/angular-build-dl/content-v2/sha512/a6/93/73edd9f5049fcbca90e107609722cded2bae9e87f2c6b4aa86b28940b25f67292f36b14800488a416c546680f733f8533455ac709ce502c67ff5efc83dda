...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    {
                        path: '', loadChildren: () => Promise.all(/*! import() | search-search-module */[__webpack_require__.e("default~home-pages-home-home-module~home-pages-home10-home10-module~home-pages-home2-home2-module~ho~d52f8f32"), __webpack_require__.e("search-search-module")]).then(__webpack_require__.bind(null, /*! ../search/search.module */ "./src/app/search/search.module.ts")).then(m => m.SearchPageModule)
                    },
                    productDetailPage, addReviewPage, storePage, reviewPage,
                    productsPage
                ]
...
let TabsPage = class TabsPage {
    constructor(shared, config, navCtrl, platform) {
        this.shared = shared;
        this.config = config;
